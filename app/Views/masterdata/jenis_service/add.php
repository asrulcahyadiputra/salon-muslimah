<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/user/dashboard/masterdata/jenis_service/save" method="post">
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="id_aset" class="col-sm-3 col-form-label">Jenis Service</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="id" name="jenisService">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="id_aset" class="col-sm-3 col-form-label">Harga Service</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="id" name="harga_service">
                        </div>
                    </div>
                </div>
