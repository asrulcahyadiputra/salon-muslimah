            ...
            <div class="col mt-2">
                <form action="/Absensi/save" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="namaKaryawan" name="namaKaryawan" style="text-transform: capitalize;" required>
                        </div>

                        <label for="noTelepon" class="col-sm-2 col-form-label">No. Telepon</label>
                        <div class="col-sm-3">
                            <input type="varchar" class="form-control" pattern="\d*" id="noTelepon" minlength="6" maxlength="13" name="noTelepon" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3" style="margin-top: -1rem;">
                            <input type="date" class="form-control" id="tanggalBergabung" name="tanggalBergabung" value="<?php echo date("Y-m-d"); ?>" required>
                        </div>
                    </div>
