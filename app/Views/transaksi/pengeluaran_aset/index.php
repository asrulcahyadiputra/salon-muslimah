...
<div class="main-content">
    ...
    <section class="section" style="background-color: white; padding: 2rem; box-shadow: 1px 2px 3px 1px rgba(0,0,0,0.75); border-radius: 15px;">
        <div class="row">
            <div class="col-lg-10">
                <h4>Transaksi Pembelian Aset</h4>
            </div>
            <div class="col-lg-2">
                        ...
                        <tbody>
                            ...
                            foreach ($pengeluaran_aset as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td class="action text-center"><?= ($value->status == 'selesai') ? '<span class="badge badge-success">Sudah Bayar</span>' : '<span class="badge badge-warning">' . ucwords($value->status) . '</span>' ?></td>
                                    <!-- <td>
...
<?= $this->include('transaksi/pengeluaran_aset/detail'); ?>
...
<script>
    ...
    $('#tablemenu').on('click', 'tr', function(e) {
        if (!$(e.target).closest('.action').length) {
            ...
            $.ajax({
                type: 'get',
                url: '<?= base_url("Transaksi/detailPembelianAset") ?>',
                data: {
                    id_transaksi: id
                },
                dataType: 'json',
                success: (res) => {
                    ...
                    html += `</tbody></table>`;
                    let url = "<?= base_url('Transaksi/cetakPembelianAset') ?>/" + data_m.id_transaksi;
