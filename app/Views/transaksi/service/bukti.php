    ...
    <div class="row mt-4">
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="card-title">Bukti Transaksi Service</h4>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered mt-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">Rp <?= number_format($data_m->diskon, 2, ',', '.') ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right" colspan="2">Total</td>
                                        <td class="text-right">Rp <?= number_format($data_m->subtotal, 2, ',', '.') ?></td>
                                    </tr>
                                    <tr>

                                        <td class="text-center" style="font-weight:bold;" colspan="3"><i><?= terbilang($data_m->subtotal) ?> Rupiah</i></td>
                                    </tr>
                                </tbody>
                            </table>
